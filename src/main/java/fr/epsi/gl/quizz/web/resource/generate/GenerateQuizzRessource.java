...
public class GenerateQuizzRessource extends ServerResource{

	 @Inject
	    public GenerateQuizzRessource(BusCommande busCommande, RechercheQuestions recherche) {
	        this.busCommande = busCommande;
	        this.recherche = recherche;
	 }
	  @Get
	    public ModeleEtVue représente() {
	       return ModeleEtVue.crée("/generation-quizz/generate").avec("questions", recherche.toutes());
	    }
	  ...
	  @Get
	    public void crée(Form formulaire) {
	        ...
	        setLocationRef("/generate/" + Futures.getUnchecked(idQuizz));	       
	   }
